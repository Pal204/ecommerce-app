        ...
        <div>
            ...
            <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28'>
                ...
                <div className='flex flex-col justify-center items-start gap-6'>
                    ...
                    <p className='text-gray-500'>54706 Willms Station <br />Suite 350, Washington, USA</p>
                    <p className='text-gray-500'>Tel: +91-12354778955 <br />Email: foreever@gmail.com</p>
